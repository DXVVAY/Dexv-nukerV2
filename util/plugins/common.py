...
def setTitle(_str):
    ...
    if system == 'nt':
        #if its windows
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} | Made By DEXV#6969")
    elif system == 'posix':
        #if its linux
        os.system(f"\033]0;{_str} | Made By DEXV#6969\a", end='', flush=True)
    else:
...
def proxy_scrape(): 
    ...
    startTime = time.time()
    #create temp dir
    temp = os.getenv("temp")+"\\dexv_proxies"
    print(f"{Fore.YELLOW}Please wait while dexvNuker Scrapes proxies for you!{Fore.RESET}")
...
def getTheme():
    themes = ["dexvous", "dark", "fire", "water", "neon"]
    with open(os.getenv("temp")+"\\dexv_theme", 'r') as f:
        text = f.read()
...
def setTheme(new: str):
    with open(os.getenv("temp")+"\\dexv_theme", 'w'): pass
    with open(os.getenv("temp")+"\\dexv_theme", 'w') as f:
        f.write(new)
...
{Fore.RESET}[{Fore.GREEN}1{Fore.RESET}]{Fore.LIGHTBLACK_EX} Nuke Account                                |{Fore.RESET}[{Fore.GREEN}10{Fore.RESET}]{Fore.LIGHTBLACK_EX} Block Friends          |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} Qr code tokengrabber 

{Fore.RESET}[{Fore.GREEN}2{Fore.RESET}]{Fore.LIGHTBLACK_EX} Unfriend all friends                        |{Fore.RESET}[{Fore.GREEN}11{Fore.RESET}]{Fore.LIGHTBLACK_EX} Token checker          |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} Rat tool 

{Fore.RESET}[{Fore.GREEN}3{Fore.RESET}]{Fore.LIGHTBLACK_EX} Delete and leave all servers                |{Fore.RESET}[{Fore.GREEN}12{Fore.RESET}]{Fore.LIGHTBLACK_EX} Token bruteforcer      |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} File tokengrabber

{Fore.RESET}[{Fore.GREEN}4{Fore.RESET}]{Fore.LIGHTBLACK_EX} Spam Create New servers                     |{Fore.RESET}[{Fore.GREEN}13{Fore.RESET}]{Fore.LIGHTBLACK_EX} Bot nuker              |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} Account disabler

{Fore.RESET}[{Fore.GREEN}5{Fore.RESET}]{Fore.LIGHTBLACK_EX} Dm Deleter                                  |{Fore.RESET}[{Fore.GREEN}14{Fore.RESET}]{Fore.LIGHTBLACK_EX} Profile Changer        |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} Selfbot 

{Fore.RESET}[{Fore.GREEN}6{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Dm                                     |{Fore.RESET}[{Fore.GREEN}15{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Report            |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} [coming soon]

{Fore.RESET}[{Fore.GREEN}7{Fore.RESET}]{Fore.LIGHTBLACK_EX} Enable Seizure Mode                         |{Fore.RESET}[{Fore.GREEN}16{Fore.RESET}]{Fore.LIGHTBLACK_EX} GroupChat Spammer      |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} [coming soon]

{Fore.RESET}[{Fore.GREEN}8{Fore.RESET}]{Fore.LIGHTBLACK_EX} Get information from a targetted account    |{Fore.RESET}[{Fore.GREEN}17{Fore.RESET}]{Fore.LIGHTBLACK_EX} Webhook Destroyer      |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} [coming soon]

{Fore.RESET}[{Fore.GREEN}9{Fore.RESET}]{Fore.LIGHTBLACK_EX} Log into an account                         |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} VideoCrash Maker                 |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} Settings                                      
{Fore.WHITE}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────''')
